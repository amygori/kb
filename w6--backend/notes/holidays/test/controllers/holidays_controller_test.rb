...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { country_of_origin: @holiday.country_of_origin, name: @holiday.name, observed_on: @holiday.observed_on } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { country_of_origin: @holiday.country_of_origin, name: @holiday.name, observed_on: @holiday.observed_on } }
